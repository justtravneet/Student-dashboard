...
export { default as logo } from "../assets/img/Frame 18.png";
...
export { default as User16 } from "../assets/img/user/user16.jpg";
export { default as User17 } from "../assets/img/user/user-17.jpg";
...
export { default as instructortabel01 } from "../assets/img/instructor/instructor-table-01.jpg";
export { default as instructortabel02 } from "../assets/img/instructor/instructor-table-02.jpg";
export { default as instructortabel03 } from "../assets/img/instructor/instructor-table-03.jpg";
export { default as instructortabel04 } from "../assets/img/instructor/instructor-table-04.jpg";
export { default as instructortabel05 } from "../assets/img/instructor/instructor-table-05.jpg";
export { default as course02 } from "../assets/img/course/course-02.jpg";
export { default as course03 } from "../assets/img/course/course-03.jpg";
export { default as course04 } from "../assets/img/course/course-04.jpg";
export { default as course05 } from "../assets/img/course/course-05.jpg";
export { default as course07 } from "../assets/img/course/course-07.jpg";
export { default as course08 } from "../assets/img/course/course-08.jpg";


export { default as course28 } from "../assets/img/course/course-28.jpg";
export { default as course29 } from "../assets/img/course/course-29.jpg";
export { default as course30 } from "../assets/img/course/course-30.jpg";
export { default as pay } from "../assets/img/icon/paypal-icon.svg";


export { default as play01 } from "../assets/img/icon/play-01.svg";
export { default as voice } from "../assets/img/icon/voice.svg";
export { default as like } from "../assets/img/icon/like.svg";
export { default as heart } from "../assets/img/icon/heart.svg";
export { default as chatImg } from "../assets/img/chat-img-01.jpg";
export { default as fb } from "../assets/img/icon/fb-icon.svg";
